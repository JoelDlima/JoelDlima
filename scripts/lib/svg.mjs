...
const TITLE = "Charter, 'Iowan Old Style', 'Palatino Linotype', 'Book Antiqua', Palatino, Georgia, serif";
export const FACES = { mono: MONO, display: SANS, sans: SANS, title: TITLE };
